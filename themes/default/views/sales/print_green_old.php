...
$table='<table width="100%">
			...
			';
					...
					$c=1;
					foreach($rows as $row){
						$total_page = ceil($c/23);
					}
					$max_items = $total_page * 23;
					$total_item = sizeof($rows);
					$add_blank_page = $max_items - $total_item;
					
					if($add_blank_page > 0 && $add_blank_page < 5){
						$topArr = $total_item;
						foreach($add_blank_page as $add_blank){
					...
					*/
					...
					//$this->erp->print_arrays($num_row,"___",$none_row,"___",$none_row-$num_row);
