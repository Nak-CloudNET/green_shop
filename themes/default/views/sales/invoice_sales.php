            ...
            <?php if (isset($biller->logo)) { ?>
			 ...
			 <?php } ?>
                <div class="col-xs-6 text-center">
					<p style="margin-top:10px;font-family: Khmer M1;font-size:20px;font-weight:bold;"><?= $biller->company != '-' ? $biller->company : $biller->name; ?></p>
					<p style="font-family: Khmer M1"><?= $biller->address != '-' ? $biller->address : $biller->address; ?></p>
