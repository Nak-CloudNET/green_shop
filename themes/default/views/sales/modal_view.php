            ...
            <?php if (!$Supplier || !$Customer) { ?>
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						...
						<div class="btn-group">
                            <a href="<?= site_url('sales/print_green/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('sales_invoice') ?>">
                                <i class="fa fa-download"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('Sales_Invoice_Green_Fresh') ?></span>
                            </a>
                        </div>
