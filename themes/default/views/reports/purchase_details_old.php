                    ...
                    <table class="table table-bordered table-hover table-striped table-condensed reports-table">
							...
							?>
								...
								<?php 
									if($purchase->type == 1){
										foreach($purchases_detail as $purchase_detail){
											...
											$total_purchase_cost    += $purchase_detail->quantity * $purchase_detail->net_unit_cost;
											
											$total_all_net_unit_cost += $purchase_detail->quantity * $purchase_detail->net_unit_cost;
								...
								?>
										<tr>	
											...
											<td class="center"><?= $this->erp->formatDecimal($purchase_detail->net_unit_cost) ?></td>
											<td class="right"><?= $this->erp->formatDecimal($purchase_detail->quantity); ?></td>
											<td class="right"><?= $this->erp->formatDecimal($purchase_detail->quantity *$purchase_detail->net_unit_cost ); ?></td>
                        ...
                        <tfoot>
							...
							<tr>
								...
								<th class="right" style="color:#0586ff"><?= $this->erp->formatMoney($total_all_net_unit_cost); ?></th>
							</tr>
							<!--
							<tr>
                                <th colspan="3"></th>
