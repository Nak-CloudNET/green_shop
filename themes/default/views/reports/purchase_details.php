                    ...
                    <table class="table table-bordered table-hover table-striped table-condensed reports-table">
						<thead>
							<tr class="info-head">
								...
								<th class="center"><?= lang("date"); ?></th>
								<th class="center"><?= lang("supplier"); ?></th>
								<th class="center"><?= lang("reference_no"); ?></th>
								<th  class="center"><?= lang("item"); ?></th>
								<th  class="center"><?= lang("project"); ?></th>
								<th ><?= lang("warehouse"); ?></th>
								<th ><?= lang("unit cost"); ?></th>
								<th ><?= lang("item discount"); ?></th>
								<th ><?= lang("quantity"); ?></th>
								<th ><?= lang("subtotal"); ?></th>
							</tr>
						</thead>
						...
						<?php 
							...
							if(count($purchases) > 0){
								...
								$total_all_purchase_cost = 0;
								foreach($purchases as $key => $purchase){
									$total_quantity = 0;
									$total_purchase_cost = 0;
									$table_purchase_order_items = "erp_purchase_items";
									$total_all_purchase_cost += $purchase->total;
									$sql="SELECT 
											product_name,
											product_code,
											net_unit_cost,
									...
									<?php 
										...
										if($purchase->type == 1){
											foreach($purchases_detail as $purchase_detail){
												//$this->erp->print_arrays($purchase_detail);
												$total_quantity 		+= $purchase_detail->quantity;
												$total_purchase_cost    += $purchase_detail->quantity * $purchase_detail->unit_cost - $purchase_detail->item_discount;
									...
									?>
											<tr>	
												...
												<td class="center"><?= $this->erp->formatDecimal($purchase_detail->unit_cost) ?></td>
												<td class="center"><?= $this->erp->formatDecimal($purchase_detail->item_discount) ?></td>
												<td class="right"><?= $this->erp->formatDecimal($purchase_detail->quantity); ?></td>
												<td class="right"><?= $this->erp->formatDecimal($purchase_detail->quantity *$purchase_detail->unit_cost - $purchase_detail->item_discount); ?></td>
									...
									<tr style="font-weight:bold;">
										...
										<td class="right"><?= $this->erp->formatMoney($total_purchase_cost); ?></td>
									</tr>
                        ...
                        <tfoot>
							...
							<tr>
								...
								<th class="right" style="color:#0586ff"><?= $this->erp->formatMoney($total_all_purchase_cost); ?></th>
							</tr>
							<!--
							<tr>
                                <th colspan="3"></th>
